...
object Bayes extends App{
  ...
  val modelMap = initModel("D:/mlearning/testModel")
  val stopWords = getStopWords("D:/mlearning/dicts/stop_words_CN")
  ...
  val cateString = industryPredict(content, modelMap, stopWords)
  println(cateString)
  ...
  def industryPredict(content: String, models: Map[String, Map[String, Any]], stopWords: Array[String]): String = {
    val wordSegNoStop = TextProcess.process(content, stopWords)
