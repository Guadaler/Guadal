...
object NB_predict extends App{
  ...
  val modelMap=init("D:/Model")
  val stopWords=Source.fromFile("E:/data/stop_words_CN").getLines().toArray  //读取停用词典并转成Array
  ...
  val result =predict(content, modelMap, stopWordsBr)
