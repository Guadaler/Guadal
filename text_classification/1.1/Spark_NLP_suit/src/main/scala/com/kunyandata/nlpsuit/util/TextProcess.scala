...
object TextProcess {
  ...
  /**
    ...
    */
  def removeStopWords(content: Seq[String], stopWords:Array[String]): Seq[String] = {
  ...
  /**
    ...
    * @return 返回分词去停后的结果
    */
  def process(content: String, stopWordsBr: Broadcast[Array[String]]): Seq[String] = {
    // 格式化文本
  ...
  def main(args: Array[String]): Unit = {
    ...
    val conf = new SparkConf().setAppName("wordSegmentation").setMaster("local")
...
//    val trainingSet = sc.textFile("hdfs://222.73.34.92:9000/mlearning/trainingSet").collect()
