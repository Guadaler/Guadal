...
object SubjectWord {
  ...
  /**
    ...
    * @return 候选词集合
    */
  def getCandiWordFromSpareWords(communityWordArr: Array[String]): Array[String] = {
  ...
  /**
    ...
    * @return 主题词
    */
  def getWordsFromCandiWords(CandiWords: Array[String]): Array[String] = {
  ...
  /**
    ...
    * @return 候选词
    */
  def getWordBaseOnOverlap(communityWordArr: Array[String]): Array[String] ={
