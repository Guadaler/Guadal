...
object Run {
  def main(args: Array[String]) {
    ...
    //加载主题模型
//    val model = DistributedLDAModel.load(sc,"D:\\333_WordExtraction\\Run\\Model")
//    //加载词表
//    val vocab = sc.textFile("D:\\333_WordExtraction\\Run\\Dict\\vocab.txt").collect()
...
//        println("    " + numVocabMap(topicWeight._1(word)) + "  "+ topicWeight._1(word)+ " : "+ topicWeight._2(word))
        println("    " + topicWeight._1(word)+ " : "+ topicWeight._2(word))
      }
